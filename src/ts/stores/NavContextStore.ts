...
export class NavContextStore extends StoreBase {
    ...
    navigateToTodoList(selectedTodoId?: string, showNewTodoPanel = false,showHomePanel = false,  showSwap = false,showVideoNFT=false,showAudioNFT=false,showImageNFT=false,showObjectNFT=false,showICO=false,showProfile=false,selectedTodoId2?: string,selectedTodoId3?: string) {
       
        this.setNavContext(NavActions.createTodoListContext(this._isUsingStackNav, selectedTodoId, showNewTodoPanel, showHomePanel,  showSwap,showVideoNFT,showAudioNFT,showImageNFT,showObjectNFT,showICO,showProfile,selectedTodoId2,selectedTodoId3));
    }
