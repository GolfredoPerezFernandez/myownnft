...
export default class AccountMenuButton2 extends ComponentBase<AccountMenuButtonProps, AccountMenuButtonState> {
    ...
    render(): JSX.Element | null {
        ...
        return (
            ...
            )} style={{ content: [{ width: 150, height: 37, justifyContent: 'flex-start', alignItems: 'center', borderRadius: 11, }], label: _styles.label }
    ...
    private _onSelectMenuItem = async (command: string) => {
        ...
        switch (command) {
            case 'Edit Profile':
                return NavContextStore.navigateToTodoList(undefined, false, false, false, false, false, false, false, false, true)
